...
constexpr int FINDER_6M_REG_INSTANTANEOUS_VOLTAGE_PEAK = 94;     // Instantaneous Voltage Peak
constexpr int FINDER_6M_REG_INSTANTANEOUS_CURRENT_PEAK = 96;     // Instantaneous Current Peak
